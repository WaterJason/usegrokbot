...
const copyByLocale: Record<Locale, UseCaseBrowserCopy> = {
  ...
  "zh-Hant": {
    ...
    filtersTitle: "更多條件",
    closeFilters: "關閉篩選",
    showResults: (count) => `查看 ${count} 個案例`,
    selectedFilters: "已選條件",
    clearFilters: "清除篩選",
    resultCount: (count) => `${count} 個案例`,
    categoriesLabel: "分類",
    helpsLabel: "幫你做什麼",
    prepareLabel: "需要準備什麼",
    startLabel: "如何開始",
    pasteHint: "複製後，貼到 Grok Bot 裡。",
    preparePrompt: "你需要 Grok Bot，以及這段來源 Prompt。",
    prepareSetup: "你需要 Grok Bot，以及下面的公開設定。",
    prepareTeam: "先查看下面的團隊設定，確認會用到哪些 Bots。",
    startPrompt: "複製 Prompt，然後貼到 Grok Bot 裡。",
  ...
  "zh-Hans": {
    ...
    filtersTitle: "更多条件",
    closeFilters: "关闭筛选",
    showResults: (count) => `查看 ${count} 个案例`,
    selectedFilters: "已选条件",
    clearFilters: "清除筛选",
    resultCount: (count) => `${count} 个案例`,
    categoriesLabel: "分类",
    helpsLabel: "帮你做什么",
    prepareLabel: "需要准备什么",
    startLabel: "如何开始",
    pasteHint: "复制后，贴到 Grok Bot 里。",
    preparePrompt: "你需要 Grok Bot，以及这段来源 Prompt。",
    prepareSetup: "你需要 Grok Bot，以及下面的公开设置。",
    prepareTeam: "先查看下面的团队设置，确认会用到哪些 Bots。",
    startPrompt: "复制 Prompt，然后贴到 Grok Bot 里。",
