...
const pageCopy: Record<"en" | "zh-Hant" | "ja", BotTeamsPageCopy> = {
  en: {
    ...
    templatesBody: "Only real Templates already listed on GrokCases are linked here.",
  ...
  "zh-Hant": {
    ...
    templatesBody: "這裡只會連結 GrokCases 已經收錄的真實 Templates。",
  ...
  ja: {
    ...
    oneBotTitle: "テンプレート = 1つの Bot",
    oneBotBody: "一つのはっきりした目的に、1体の Bot を選びます。",
    teamTitle: "Bot チーム = 複数の Bot が協力",
    ...
    handoffLabel: "引き継ぎ",
    templatesTitle: "合うテンプレート",
    templatesBody: "ここには、GrokCases にすでに載っている実際のテンプレートだけをリンクします。",
    templateOpen: "テンプレートを開く",
    setupTitle: "組み方をコピー",
