...
export const teamSubmitUiCopy: Record<Locale, TeamSubmitUiCopy> = {
  en: {
    teamIntro: "Choose your situation, then see the matching templates.",
    stepOne: "Step 1",
    submitTitle: "Share how you use Grok Bot",
    submitLead: "Paste a public X post link first. That is the main step.",
    submitHelp:
    ...
    previewTitle: "Your UseGrokBot identity",
    previewBody:
      "Paste an X link to reveal your community Blob. The same handle always shows the same one.",
  ...
  "zh-Hant": {
    teamIntro: "先選你現在的情況，再看對應的模板。",
    stepOne: "第一步",
    submitTitle: "分享你怎樣用 Grok Bot",
    submitLead: "先貼上公開的 X 貼文連結。這是最重要的一步。",
    ...
    previewTitle: "你的 UseGrokBot 身分",
    previewBody: "貼上 X 連結後，會即時產生你的社群小機器人。同一個帳號永遠是同一隻。",
  ...
  "zh-Hans": {
    teamIntro: "先选你现在的情况，再看对应的模板。",
    stepOne: "第一步",
    submitTitle: "分享你怎样用 Grok Bot",
    submitLead: "先贴上公开的 X 帖文链接。这是最重要的一步。",
    submitHelp: "网站会读这则帖文里的作者、用到的应用和结果。通过检查后，就会出现在网站上。",
    submitReview: "一般情况不用等人批准。我们不会自己编造结果数字。原帖没有数字，就会标成产出。",
    xUrl: "公开 X 帖文链接",
    xUrlHint: "请使用公开的 x.com 或 twitter.com 帖文链接。",
    previewTitle: "你的 UseGrokBot 身份",
    previewBody: "贴上 X 链接后，会即时产生你的社区小机器人。同一个账号永远是同一只。",
    previewPlaceholder: "你的 Grok Bot",
    optionalTitle: "选填内容",
    optionalHint: "如果帖文还不够清楚，再补上提示词或备注。",
    prompt: "提示词（选填）",
    notes: "备注（选填）",
    notesHint: "原帖看不出来的内容才写。",
    missing: "请先贴上 X 帖文链接。",
    invalidUrl: "请贴公开的 x.com 或 twitter.com 帖文链接。私人链接不能使用。",
    skipped: "这则帖文没有上架。",
    failed: "现在无法读取这则帖文。请稍后再试。",
    send: "提交这则帖文",
  },
  ja: {
    teamIntro: "今の状況を選ぶと、合うテンプレートが出ます。",
    stepOne: "手順 1",
    submitTitle: "Grok Bot の使い方を共有する",
    submitLead: "まず公開の X 投稿リンクを貼ってください。これが一番大切な手順です。",
    submitHelp:
      "サイトはその投稿から作者、使ったアプリ、結果を読み取ります。確認を通れば、サイトに表示されます。",
    submitReview:
      "通常の投稿に人の承認は不要です。結果の数字は作りません。投稿に数字がなければ、Output と表示します。",
    xUrl: "公開の X 投稿リンク",
    xUrlHint: "公開の x.com または twitter.com の投稿リンクを使ってください。",
    previewTitle: "あなたの UseGrokBot の姿",
    previewBody:
