...
const pageCopy = {
  ...
  "zh-Hant": {
   ...
   allEvidence: "全部",
    allStructures: "全部",
    promptIncluded: "已公開提示詞",
    setupShared: "設定已公開",
   singleBot: "單一 Bot",
    botTeam: "Bot 團隊",
    resultsLabel: "使用案例結果",
    showing: (count: number) => `${count} 個使用案例`,
   empty: "沒有符合這組條件的使用案例。",
    clearFilters: "清除篩選",
   open: "查看使用案例",
   promptTitle: "來源提示詞",
  ...
  "zh-Hans": {
   ...
   allEvidence: "全部",
    allStructures: "全部",
    promptIncluded: "已公开提示词",
    setupShared: "设置已公开",
   singleBot: "单一 Bot",
    botTeam: "Bot 团队",
    resultsLabel: "使用案例结果",
    showing: (count: number) => `${count} 个使用案例`,
   empty: "没有符合这组条件的使用案例。",
    clearFilters: "清除筛选",
   open: "查看使用案例",
   promptTitle: "来源提示词",
...
const jaUseCaseByEnglish: Record<string, string> = {
 "Keep a living wiki for every Bot": "どの Bot にも、更新され続ける Wiki を置く",
  "Fill and sign a PDF, then wait": "PDF を記入・署名し、確認を待つ",
  "Tidy email, files, and paid subscriptions, then wait": "メール、ファイル、有料サブスクを先に整理し、変更は承認を待つ",
  "Watch the rest of your Bots": "ほかの Bot を静かに見守り、改善案だけ渡す",
 ...
 "Turn a dish into a shopping list and cooking steps": "料理名から買い物リストと手順を作る",
  "Keep a reminder board with its photos": "写真付きのリマインダーを登録し、指定時刻に知らせる",
 ...
 "Make one publishable video from two clips": "2本の素材から公開できる1本にまとめる",
  "Turn a bug into a pull request": "不具合を伝え、確認用のプルリクエストを出す",
 ...
 "Find contractors who serve your address": "自分の住所に来る業者を探す",
  "Turn today's bookmarks into one post": "今日のブックマークを、すぐ投稿できる1本にする",
 ...
 "Match this week's charges to receipts": "今週の請求と領収書を照合する",
  "Prevent conflicts between both kids' games": "2人の子どもの試合が重ならないようにする",
