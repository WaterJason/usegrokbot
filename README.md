...
> Curated Grok Bot use cases and role templates on usegrokbot.com.
...
<p align="center">
  <a href="https://github.com/WaterJason/usegrokbot/stargazers"><img src="https://img.shields.io/github/stars/WaterJason/usegrokbot?style=flat-square" alt="GitHub stars" /></a>
  <a href="https://github.com/WaterJason/usegrokbot/blob/main/LICENSE"><img src="https://img.shields.io/badge/license-MIT-green?style=flat-square" alt="MIT License" /></a>
...
![GrokCases](https://usegrokbot.com/og.png)

## What is GrokCases?

GrokCases is an open-source discovery hub for real Grok Bot use cases.

Instead of dumping prompts into a directory, GrokCases starts with public examples from X and the wider web, keeps attribution to the original source, explains what was built in plain language, and connects useful examples to ready-to-build workflows.
...
GrokCases distinguishes between different levels of verification:

- ✅ **Official** — demonstrated or published by xAI / official sources.
- 🧪 **Tested** — tested by GrokCases.
...
Useful Grok Bot examples are spread across X, tutorials, videos, GitHub repositories, newsletters, and community writeups. GrokCases turns those scattered signals into a structured discovery layer.
...
Useful public indexes such as [`awesome-grok-bot`](https://github.com/RongleCat/awesome-grok-bot) can act as discovery sources, while GrokCases still links to and attributes the original underlying source.

## Zero-touch automatic source ingestion

GrokCases watches the **Field Cases** section of [`RongleCat/awesome-grok-bot`](https://github.com/RongleCat/awesome-grok-bot) every 6 hours.
...
For X cases, GrokCases prefers the machine extraction path and falls back to a conservative source-index summary if AI extraction is unavailable.

For non-X cases, the ingestion worker reads source metadata such as author, date, page title, site name, YouTube oEmbed data, or public GitHub repository metadata. It **does not copy article, video, newsletter, or repository bodies** into GrokCases.
...
The source feed is an index of candidates, not permission to republish linked content. GrokCases summarizes conservatively, preserves attribution, and links back to the original source.
...
Multi-source ingestion is now live. The next ingestion priorities are additional public source indexes, `@GrokCases` mention ingestion, semantic duplicate detection, and better integration mapping.
...
The MIT license covers the software code. Branding and trademarks remain with their respective owners; this repository does not grant trademark rights.
...
GrokCases is an independent community resource and is not affiliated with, endorsed by, or sponsored by xAI, X, or Cursor.

---

If GrokCases helps you discover a useful Grok Bot workflow, consider giving the repo a ⭐ — it helps more people find the project.
