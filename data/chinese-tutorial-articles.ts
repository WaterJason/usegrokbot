...
export const chineseTutorialArticles: DiscoverStory[] = [
  ...
  tutorialArticle({
    slug: "zh-tutorial-cgnot996-hangzhou-quota",
    title: "杭州线下活动回看：我是怎么让 Grok Bot 额度更耐用的",
    localizedArticleTitles: {
      en: "Hangzhou session notes: how I made Grok Bot credits last longer",
      "zh-Hant": "杭州線下活動回看：我是怎麼讓 Grok Bot 額度更耐用的",
      "zh-Hans": "杭州线下活动回看：我是怎么让 Grok Bot 额度更耐用的",
      ja: "杭州オフライン回顧：Grok Bot の枠を長持ちさせる方法",
    },
    authorName: "铁柱AGI",
    handle: "cgnot996",
    publishedAt: "2026-09-06",
    xPostUrl: "https://x.com/cgnot996/status/2096415217710461078",
    articleUrl: "https://x.com/i/article/2096274174239285248",
    category: "operations",
    outcomes: ["save-time", "automate-work"],
    difficulty: "medium",
  }),
  tutorialArticle({
    slug: "zh-tutorial-cgnot996-developer-credits-year",
    title: "同样 $100 X 开发者积分，为什么我能用一年",
    localizedArticleTitles: {
      en: "Same $100 in X developer credits — why mine can last a year",
      "zh-Hant": "同樣 $100 X 開發者積分，為什麼我能用一年",
      "zh-Hans": "同样 $100 X 开发者积分，为什么我能用一年",
      ja: "同じ $100 の X 開発者クレジットで、なぜ私は1年使えるのか",
    },
    authorName: "铁柱AGI",
    handle: "cgnot996",
    publishedAt: "2026-08-31",
    xPostUrl: "https://x.com/cgnot996/status/2094220949340185078",
    articleUrl: "https://x.com/i/article/2094108824949096448",
    category: "operations",
    outcomes: ["save-time", "automate-work"],
    difficulty: "medium",
  }),
  tutorialArticle({
    slug: "zh-tutorial-cgnot996-bind-x-credits",
    title: "马斯克又撒钱了：Grok Bot 绑定 X 送开发者积分，坑我帮你踩好了",
    localizedArticleTitles: {
      en: "Musk credits again: binding Grok Bot to X for developer credits, pitfalls mapped",
      "zh-Hant": "馬斯克又撒錢了：Grok Bot 綁定 X 送開發者積分，坑我幫你踩好了",
      "zh-Hans": "马斯克又撒钱了：Grok Bot 绑定 X 送开发者积分，坑我帮你踩好了",
      ja: "Grok Bot を X に連携して開発者クレジットを受け取る手順と注意点",
    },
    authorName: "铁柱AGI",
    handle: "cgnot996",
    publishedAt: "2026-08-30",
    xPostUrl: "https://x.com/cgnot996/status/2094000213681930353",
    articleUrl: "https://x.com/i/article/2093995265120493568",
    category: "operations",
    outcomes: ["save-time", "automate-work"],
    difficulty: "easy",
  }),
