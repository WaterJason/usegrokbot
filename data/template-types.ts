...
export const templateHubUiCopy = {
  ...
  "zh-Hant": {
    ...
    allTemplates: "全部模板",
    teamTitle: "Bot 團隊模板",
    teamIntro: "先選擇你現在的情況：還沒有 Bot 團隊，或已經有多個 Bot。",
    teamCount: "{n} 個已確認的團隊模板",
    categoryLabel: "你現在是哪一種情況？",
    categoryCount: "{n} 個模板",
    builderTitle: "還沒有 Bot 團隊",
    builderBody: "這些模板會按你的需要，替你建立多個不同用途的 Bot。",
    orchestratorTitle: "已經有多個 Bot",
    orchestratorBody: "這些模板會把每件事交給最合適的 Bot。",
    builderListTitle: "會替你建立 Bot 的模板",
    orchestratorListTitle: "會替你分配事情的模板",
    evidenceNote: "只收錄清楚說明會建立或管理多個 Bot 的模板。",
    typeLabel: "模板類型",
    typeAll: "全部",
    typeSingle: "單一 Bot",
    typeTeam: "Bot 團隊",
  ...
  "zh-Hans": {
    ...
    allTemplates: "全部模板",
    teamTitle: "Bot 团队模板",
    teamIntro: "先选择你现在的情况：还没有 Bot 团队，或已经有多个 Bot。",
    teamCount: "{n} 个已确认的团队模板",
    categoryLabel: "你现在是哪一种情况？",
    categoryCount: "{n} 个模板",
    builderTitle: "还没有 Bot 团队",
    builderBody: "这些模板会按你的需要，替你建立多个不同用途的 Bot。",
    orchestratorTitle: "已经有多个 Bot",
    orchestratorBody: "这些模板会把每件事交给最合适的 Bot。",
    builderListTitle: "会替你建立 Bot 的模板",
    orchestratorListTitle: "会替你分配事情的模板",
    evidenceNote: "只收录清楚说明会建立或管理多个 Bot 的模板。",
    typeLabel: "模板类型",
    typeAll: "全部",
    typeSingle: "单一 Bot",
    typeTeam: "Bot 团队",
  ...
  ja: {
    ...
    teamTitle: "Bot チームのテンプレート",
    teamIntro:
      "今の状況を選んでください。まだ Bot チームがないか、すでに複数の Bot があるか。",
    teamCount: "確認済みのチームテンプレート {n} 件",
    categoryLabel: "今はどの状況ですか？",
    categoryCount: "{n} 件のテンプレート",
    builderTitle: "まだ Bot チームがない",
    builderBody: "これらのテンプレートは、用途の違う複数の Bot を代わりに作ります。",
    orchestratorTitle: "すでに複数の Bot がある",
    orchestratorBody: "これらのテンプレートは、一件ずつ一番合う Bot に渡します。",
    builderListTitle: "複数の Bot を代わりに作るテンプレート",
    orchestratorListTitle: "依頼を振り分けるテンプレート",
    evidenceNote:
      "公開説明が、複数の Bot を作るか管理すると明記しているテンプレートだけを載せています。",
    typeLabel: "テンプレートの種類",
    typeAll: "すべて",
    typeSingle: "1つの Bot",
    typeTeam: "Bot チーム",
